...
if ($currentPrincipal.IsInRole([Security.Principal.WindowsBuiltInRole]::Administrator)) {
  ...
  if ($cred) {
      Install-BoxstarterPackage -PackageName https://raw.githubusercontent.com/benjcksn/flare-vm/master/flarevm_malware.ps1 -Credential $cred
  } else {
      Install-BoxstarterPackage -PackageName https://raw.githubusercontent.com/benjcksn/flare-vm/master/flarevm_malware.ps1
  }
